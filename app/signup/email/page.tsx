        ...
        <Card sx={{ width: '100%', background: 'linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 100%)', border: '2px solid #73FDAA', borderRadius: 3 }}>
          <CardContent sx={{ p: 4 }}>
            ...
            <form onSubmit={handleEmailSignup}>
              ...
              <TextField fullWidth label="Password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} sx={{ mb: 3 }} InputProps={{ style: { color: '#fff' } }} InputLabelProps={{ style: { color: '#73FDAA' } }} />
