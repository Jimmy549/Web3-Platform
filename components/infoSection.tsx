  ...
  return (
    <div className="relative py-10 min-h-screen">
      ...
      <section className="flex flex-wrap py-20 container mx-auto relative justify-around ">
        ...
        <div>
          <div className="my-10 text-right bg-gradient-to-r from-[#c4c4c40d] to-[#73fdaae7] max-w-full  py-5 px-10 rounded-xl flex justify-end items-end flex-col transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(115,253,170,0.5)] cursor-pointer">
