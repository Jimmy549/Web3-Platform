    ...
    <footer className="py-6 bg-black w-full">
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid  md:grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6 max-w-md ">
            <a
              href="#"
            ...
            <p className="text-xl">
              Amet minim mollit non deserunt ullamco est aliqua dolor do amet
              sint. Velit officia consequatduis enim velit mollit. Exercitation
              veniamconsequat sunt nostrud amet.
            </p>
          </div>
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-3xl font-medium">Quick Link</p>
            <ul>
              <li className="py-3">
                <a href="#" className="">
                  How it Works
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3 ">
            ...
            <div className="flex items-center justify-center md:items-baseline md:justify-start">
              <a
                href="#"
                title="Email"
