...
export default function Card({ img }: Props) {
  return (
    <div className="bg-[#010010] w-[297px] rounded-xl backdrop- shadow-emerald-600 h-[187px] p-4 border items-center transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(115,253,170,0.6)] hover:border-[#73FDAA] cursor-pointer">
